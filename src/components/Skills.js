...
import meter11 from "../assets/img/meter11.jpg";
            ...
            <div className="row">
                <div className="col-12">
                    <div className="skill-bx wow zoomIn">
                        <h2>Skills</h2>
                        <p>I have augmented my skills through the experiences gained from learning and projects.<br></br> My skills include: </p>
